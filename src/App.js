import React, { useState, useEffect } from 'react'; //Agregue el useEffect para google :)
...
import ReactGA from 'react-ga'; // Google Analytics chavos Chris505
...
function App() {
  ...
  const addToCart = (product) => {
    ...
    alert(`${product.title || product.name || 'Producto desconocido'} ha sido agregado al carrito!`);
  };
        ...
        <main className="flex-fill">
          <section className="container my-4">
            <Routes>
              ...
              <Route path="/product/:id" element={<Product addToCart={addToCart} addToWishlist={addToWishlist}/>} />
              <Route path="/DetailsTD/:id" element={<DetailsTD addToCart={addToCart} addToWishlist={addToWishlist}/>} />
          ...
          <div className="container">
            <div className="row">
              ...
              >
                ...
                <p>Spin Records es tu tienda de discos en línea, donde puedes encontrar los mejores vinilos.</p>
              </div>
              <div 
                className="col-md-4 mb-3" 
                style={{ 
